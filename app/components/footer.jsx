    ...
    return ( 
        <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div className="text-center">
                <div>
                <a className="flex-none text-xl font-semibold text-black dark:text-goldenrod dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">Mphatso</a>
                </div>
                {/* End Col */}

                <div className="mt-3">
                <p className="text-gray-500">Expirienced web developer, crafting inspiring online expiriences.</p>
                <p className="text-gray-500">© Mphatso. 2023. All rights reserved.</p>
                </div>
